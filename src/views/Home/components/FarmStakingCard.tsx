...
const FarmedStakingCard = () => {
  ...
  return (
    <div className="rbs-card h-full relative flex flex-col justify-center">

      <div className="text-white text-2xl font-bold mb-6">Farms & Staking</div>
      <img src="/images/metamask.svg" alt="rbs-ico" width="300" />
